...
export const RouteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375c-.621 0-1.125-.504-1.125-1.125V11.25c0-.621.504-1.125 1.125-1.125h1.5V9.75c0-1.242 1.008-2.25 2.25-2.25h9.75c1.242 0 2.25 1.008 2.25 2.25v1.5h1.5c.621 0 1.125.504 1.125 1.125v6.375c0 .621-.504 1.125-1.125-1.125H18.75m-9 0h6m-6 0V9.75M9 9.75h6" />
       <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0" />
    </svg>
);
...
export const BoxIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-9-5.25-9 5.25M21 7.5v9l-9 5.25-9-5.25v-9M21 7.5L12 12.75M3 7.5l9 5.25m-9-5.25v9l9 5.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25v10.5" />
    </svg>
);
...
export const MyLocationIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v-1.5m0 1.5c-1.24 0-2.25-1.01-2.25-2.25S10.76 4.5 12 4.5s2.25 1.01 2.25 2.25-1.01 2.25-2.25 2.25zm0 0v.01M12 15.75v1.5m0-1.5c1.24 0 2.25 1.01 2.25 2.25S13.24 21 12 21s-2.25-1.01-2.25-2.25 1.01-2.25 2.25 2.25zm0 0v-.01M8.25 12h-1.5m1.5 0c0-1.24-1.01-2.25-2.25-2.25S4.5 10.76 4.5 12s1.01 2.25 2.25 2.25 2.25-1.01 2.25-2.25zm0 0h.01M15.75 12h1.5m-1.5 0c0 1.24 1.01 2.25 2.25 2.25s2.25-1.01 2.25-2.25-1.01-2.25-2.25-2.25-2.25 1.01-2.25 2.25zm0 0h-.01" />
    </svg>
);
...
export const NoLeftTurnIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5V4.5m-4.5 9H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h4.875" />
...
export const ThermometerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6.375c0-1.036.84-1.875 1.875-1.875h.375c1.036 0 1.875.84 1.875 1.875v10.125c0 1.036-.84 1.875-1.875 1.875h-.375a1.875 1.875 0 01-1.875-1.875V6.375z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 16.5a4.5 4.5 0 11-4.95-4.402m4.95 4.402a4.5 4.5 0 004.95-4.402m-4.95 4.402V3.75" />
    </svg>
);
...
export const TimeConstraintIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 1v2m-4 1.25L7.25 5.5M4.25 9.5H2.25m1.25 4L2.25 14.5m3.75 3.75L7.25 19.5m4.75 1v2m4-1.25l.75 1.25m2.75-4.75h2m-1.25-4l1.25-1.25M12 6H9" />
    </svg>
);
...
export const ApartmentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h.008v.008H9V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM9 11.25h.008v.008H9v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 4.5h.008v.008H9v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm6-8.25h.008v.008h-.008V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 4.5h.008v.008h-.008v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 4.5h.008v.008h-.008v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
    </svg>
);

export const LockerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 21v-16.5A2.25 2.25 0 016.75 2.25h10.5A2.25 2.25 0 0119.5 4.5v16.5M4.5 21h15M4.5 21H3m1.5 0H6m12 0h1.5m-1.5 0h-1.5M4.5 6H12m0 0v1.5m0-1.5H15M12 6H9m3 0H6m6 0h3m-3 0V4.5m0 1.5V9m-3 3H9m3 0v1.5m0-1.5H15m-3 0h3m-3 0v-1.5m0 1.5V15" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 13.5a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
    </svg>
);
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.574l6.19 5.238C44.438 36.338 48 30.656 48 24c0-1.341-.138-2.65-.389-3.917z" />
    </svg>
);
...
export const SettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.008 1.11-1.223.55-.215 1.154-.215 1.704 0 .55.215 1.02.68 1.11 1.223l.073.438c.11.66.452 1.253.905 1.728.453.475.993.81 1.62.977l.462.122c.628.165 1.14.593 1.44 1.15.3.557.3 1.22-.002 1.777l-.14.28a9.14 9.14 0 01-1.08 1.948 9.2 9.2 0 01-1.95 1.54l-.427.27c-.622.395-1.166.92-1.536 1.536a9.2 9.2 0 01-1.54 1.95l-.27.427c-.395.622-.92 1.165-1.536 1.536a9.14 9.14 0 01-1.948 1.08l-.28.14c-.557.302-1.22.302-1.777 0l-.28-.14a9.14 9.14 0 01-1.948-1.08 9.2 9.2 0 01-1.54-1.95l-.27-.427c-.37-.616-.893-1.14-1.536-1.536a9.2 9.2 0 01-1.95-1.54l-.427-.27c-.628-.41-1.13-.915-1.488-1.53l-.14-.28c-.302-.557-.302-1.22 0-1.777l.14-.28a9.14 9.14 0 011.08-1.948 9.2 9.2 0 011.95-1.54l.427-.27c.622-.395 1.166-.92 1.536-1.536a9.2 9.2 0 011.54-1.95l.27-.427c.41-.628.915-1.13 1.53-1.488l.462-.122c.628-.165 1.167-.517 1.62-.977.453-.475.795-1.068.905-1.728l.073-.438zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
    </svg>
);
